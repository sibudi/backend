...
public class ProductControllerTest {
    ...
    @Test
    public void promoteUserProductLevel() throws Exception{
        String str = "{\n" +
                ...
                "  \"batchId\" : \"155374232647857847\",\n" +
                "  \"content\" : \"81381361242\",\n" +
                "  \"productLevel\" : 1\n" +
                "}";

        //String enStr = RSAUtils.encryptString(str);
        ResultActions resultActions = mockMvc.perform(post("/product/promoteUserProductLevel")
    ...
    @Test
    public void addUserWhiteList() throws Exception {
        String str = "{\n" +
                "  \"deviceId\" : \"63BC7C64-5935-442B-95BE-6187E1239216\",\n" +
                "  \"system_version\" : \"12.100000\",\n" +
                "  \"client_version\" : \"1.0.5\",\n" +
        ...
        //String enStr = RSAUtils.encryptString(str);
        ResultActions resultActions = mockMvc.perform(post("/product/addUserWhiteList")
                .contentType(MediaType.APPLICATION_JSON)
                .content(str));
