...
@WebIntegrationTest
public class SysDistControllerTest {
    ...
    @Test
    public void getSysDist() throws Exception{
        String str = "{\n" +
                ...
                "  \"pageNo\" : 1,\n" +
                "  \"pageSize\" : 10,\n" +
                "  \"language\" : \"81381361242\"\n" +
                "}";

        String enStr = RSAUtils.encryptString(str);
        ResultActions resultActions = mockMvc.perform(post("/sysDist/getSysDist")
